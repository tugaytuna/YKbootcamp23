...
function girisBasarili(id) {
  profilIsim.innerHTML = "Kullanıcı Adı: " + users[id].kullaniciAdi;
  profilAdmin.innerHTML = "Admin: " + users[id].admin;
  img1.src = users[id].resim;
...
function uyeListele() {
  ...
  adminPanel.innerHTML = "<h1>Admin Panel</h1>";
  // adminPanel.innerHTML += "<ol>";

  for (let i = 0; i < users.length; i++) {
    adminPanel.innerHTML += "<button>" + users[i].kullaniciAdi + "</button>";
    adminPanel.innerHTML += "<br/>";
  }
